...
<article id="mainview">
    <div id="description">
        <h1>Men Winter Pullover</h1>
        <strong id="price"><span>previously &yen;250.00</span> &yen;249.00</strong><p>This Product is available for all adult sizes it has undergone rudimental test to insure you buy quality,
    ...
    <div id="images">
    	<a href="images/men_winer.jpg"><img src="images/men_winer.jpg"></a>
