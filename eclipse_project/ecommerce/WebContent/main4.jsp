...
<article id="mainview">
    <div id="description">
        <h1>Han Dynasty Noblemen Men dress</h1>
        <strong id="price"><span>previously &yen;450.00</span> &yen;450.00</strong><p>This Product is available for all adult sizes it has undergone rudimental test to insure you buy quality,
    ...
    <div id="images">
    	<a href="images/Hanfu.jpg"><img src="images/Hanfu.jpg"></a>
