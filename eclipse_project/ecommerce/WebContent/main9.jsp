...
<article id="mainview">
    ...
    <div id="description">
        <h1>Trendy Summer Dress</h1>
        <strong id="price"><span>previously &yen;200.00</span> &yen;200.00</strong><p>This Product is available for all adult sizes it has undergone rudimental test to insure you buy quality,
    ...
    <div id="images">
    	<a href="images/rend_dresses.jpg"><img src="images/rend_dresses.jpg"></a>
