...
<article id="mainview">
    <div id="description">
        <h1>Women Yoga Wear</h1>
        <strong id="price"><span>previously &yen;200.00</span> &yen;249.00</strong><p>This Product is available for all adult sizes it has undergone rudimental test to insure you buy quality,
    ...
    <div id="images">
    	<a href="images/women_spor.jpg"><img src="images/women_spor.jpg"></a>
