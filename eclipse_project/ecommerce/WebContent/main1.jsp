...
<article id="mainview">
    <div id="description">
        <h1>Evening Pants</h1>
        <strong id="price"><span>previously &yen;100.00</span> &yen;100.00</strong><p>This Product is available for all adult sizes it has undergone rudimental test to insure you buy quality,
    ...
    <div id="images">
    	<a href="images/pants.jpgg"><img src="images/pants.jpg"></a>
