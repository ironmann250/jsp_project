...
<article id="mainview">
    <div id="description">
        <h1>Evening Dating Dress</h1>
        <strong id="price"><span>previously &yen;650.00</span> &yen;650.00</strong><p>This Product is available for all adult sizes it has undergone rudimental test to insure you buy quality,
    ...
    <div id="images">
    	<a href="images/Garment.jpg"><img src="images/Garment.jpg"></a>
